...
import ebaeapp.com.ebae.controller.SavePreferenceController;
...
public class SettingsView extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    ArrayAdapter<String> adapter = new ArrayAdapter<String>(SettingsView.this,
  ...
  public void onSubmitClick(View view) {
    Log.i("SettingsView", "Prefs: " + prefs.toString());
    SavePreferenceController.savePrefs(prefs, this);
